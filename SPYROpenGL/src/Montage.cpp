...
const void Montage::MontageSpyro(float rotationAiles, float rotationBouche)
{
    ...
    const float largeurDUnCoteDuCorps = (float) (sqrt(rayonCorps*rayonCorps + rayonCorps*rayonCorps - 2*rayonCorps*rayonCorps*cos(2*M_PI/5)));  //théorème d'Al-Kashi : BC²=AB²+AC²-2.AB.AC.cos(BÂC)
